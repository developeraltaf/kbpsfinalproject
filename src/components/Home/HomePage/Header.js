  ...
  return (
    <>
      <Helmet>
        ...
        <div style={{backgroundImage: 'url("/assets/images/white_wall.png")',  overflow: 'hidden', backgroundRepeat:'no-repeat',backgroundPosition: 'center',backgroundSize: 'cover'}} className="site-header" >
